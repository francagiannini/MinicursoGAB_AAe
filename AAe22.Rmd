...
La regresión lineal genera modelos globales en los que una única ecuación se aplica a todo el espacio muestral y puede emplearse con fines predictivos
